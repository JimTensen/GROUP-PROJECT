        ...
        <div className="flex flex-col ">
          <div className="">
            <div className="relative h-62 w-full mb-3">
              ...
              <img src={card.imagefront} alt={"IMAGE DESCRIPTION GOES HERE"} className=" w-full   object-fill  rounded-2xl"/>
            </div>
            <div className="flex-auto justify-evenly">
              <div className="flex flex-wrap ">
                <div className="w-full flex-none text-sm flex items-center text-gray-600">
                  ...
                  <span className="text-gray-400 whitespace-nowrap mr-3">CARD GRADE GOES HERE</span><span className="mr-2 text-gray-400">CARD DETAILS GO HERE</span>
                </div>
                <div className="flex items-center w-full justify-between min-w-0 ">
                  <h2 className="text-lg mr-auto cursor-pointer text-gray-200 hover:text-purple-500 truncate ">NAME GOES HERE</h2>
                  <div className="flex items-center bg-green-400 text-white text-xs px-2 py-1 ml-3 rounded-lg">
                    TRENDING</div>
                </div>
              </div>
              <div className="text-xl text-white font-semibold mt-1">CARD DETAILS???</div>
